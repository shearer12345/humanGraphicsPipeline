...
(function Game$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true , Virtual:true }, "Dispose", 
      JSIL.MethodSignature.Action($asm06.TypeRef("System.Array") /* AnyType[] */ )
    );
...
(function GraphicsDeviceManager$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false}, "IsWindowOnAdapter", 
      new JSIL.MethodSignature($.Boolean, [$asm06.TypeRef("System.IntPtr"), $asm04.TypeRef("Microsoft.Xna.Framework.Graphics.GraphicsAdapter")])
    );
...
(function WindowsGameHost$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:false}, "SetThreadAffinityMask", 
      new JSIL.MethodSignature($asm06.TypeRef("System.UIntPtr"), [$asm06.TypeRef("System.IntPtr"), $asm06.TypeRef("System.UIntPtr")])
    );
...
(function WindowsGameWindow$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:false}, "ScreenFromHandle", 
      new JSIL.MethodSignature($asm0D.TypeRef("System.Windows.Forms.Screen"), [$asm06.TypeRef("System.IntPtr")])
    );
